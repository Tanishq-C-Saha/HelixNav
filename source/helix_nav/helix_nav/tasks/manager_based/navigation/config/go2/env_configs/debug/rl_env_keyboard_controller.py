...
# run_simulation
def run_simulation(env: ManagerBasedRLEnv, keyboard_controller: Se2Keyboard):
    ...
    while simulation_app.is_running():
        with torch.inference_mode():
            ...
            print(f"[DEBUG]: reward_manager step rewards = {reward_manager._step_reward}\n\n")
...
# main
def main():
    env_cfg = HelixNavDebugBaseRLEnvCfg()
