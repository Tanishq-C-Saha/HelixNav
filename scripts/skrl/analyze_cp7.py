...
def _task_subfolder(task: str) -> str:
    """Sanitize a gym task id (e.g. "HelixNav-CP7-Play-v0") into a folder name."""
    ...
    while simulation_app.is_running():
        ...
        if finished.numel():
            ...
            for env_id in finished[:, 0].tolist():
                ...
                print(
                    f"[episode {episode_counter}] env={env_id} seed={ctx['seed']} D{ctx['difficulty']} {outcome} "
